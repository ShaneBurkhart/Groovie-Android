...
package com.donkka.movie.lib.layer;
...
import com.donkka.movie.lib.util.CommonUtils;
...
public class SlidingLayer extends FrameLayout {
    ...
    /**
     * Sets the listener to be invoked after a switch change {@link SlidingLayer.OnInteractListener}.
     * 
     * @param listener
     *            Listener to set
     */
